...
plot(withoutP.pca, type="l",main="PCA of floods without Pressure variables", xlab="Principal Components")
pca_withoutP <- predict(withoutP.pca,newFrame_withoutP)

withP.pca <- prcomp(newFrame_withP,center=TRUE,scale=TRUE)
plot(withP.pca, type="l", main="PCA of floods including Pressure variables", xlab="Principal Components")
...
```{r echo=FALSE}
plot(cluster2_withoutp, main="Clusters without including Pressure data", xlab="Floods", ylab = "Height", axes=FALSE)
