...
plot(withoutP.pca, type="l",main="PCA of floods without Pressure variables")
pca_withoutP <- predict(withoutP.pca,newFrame_withoutP)

withP.pca <- prcomp(newFrame_withP,center=TRUE,scale=TRUE)
plot(withP.pca, type="l", main="PCA of floods including Pressure variables")
...
```{r echo=FALSE, include=FALSE}
cluster2_withoutp <- hclust(distances_withoutP,method="ward")
cluster2_withP <- hclust(distances_withP,method="ward")
```

```{r echo=FALSE}
plot(cluster2_withoutp, main="Clusters without including Pressure data")
groups <- cutree(cluster2_withoutp, k=5)
rect.hclust(cluster2_withoutp, k=5, border="red") 
plot(cluster2_withP, main="Clusters after including Pressure data")
